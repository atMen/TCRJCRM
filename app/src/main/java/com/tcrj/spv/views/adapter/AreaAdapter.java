...
public class AreaAdapter extends BaseAdapter {
    ...
    private List<cityBean.ListInfoBean.AEntityBean.CEntityBean> itemList;
    ...
    public void setData(List<cityBean.ListInfoBean.AEntityBean.CEntityBean> list) {
        this.itemList.clear();
...
//        final AreaEntity.AreaListBean entity = (AreaEntity.AreaListBean) itemList.get(position);
        cityBean.ListInfoBean.AEntityBean.CEntityBean entity = itemList.get(position);
        ...
        view.setId(position);
        tvNoticeTitle.setText(entity.getAName());
