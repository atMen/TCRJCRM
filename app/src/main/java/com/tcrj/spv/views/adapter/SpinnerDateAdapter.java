...
public class SpinnerDateAdapter extends BaseAdapter {
    private List<SpinnerEntity> itemList;
    ...
    public void setData(List<SpinnerEntity> list) {
        clear();
        this.itemList.addAll(list);
        notifyDataSetChanged();
    }

    public void addData(List<SpinnerEntity> list) {
        this.itemList.addAll(list);
        notifyDataSetChanged();
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        final SpinnerEntity entity = itemList.get(position);
        if (entity == null)
            return null;
        if (view == null) {
        ...
        holder.tvItemTitle.setText(entity.getSpinnerName());
        return view;
    }
