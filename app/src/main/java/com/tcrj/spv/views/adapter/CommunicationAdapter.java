...
public class CommunicationAdapter extends BaseAdapter {
    private List<PersionBookEntity.ListinfoBean> itemList = null;
    private Context mContext;
    private LayoutInflater inflater;

    public CommunicationAdapter(Context mContext) {
     ...
     * @param list
     */
    public void setData(List<PersionBookEntity.ListinfoBean> list) {
        this.itemList.clear();
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        final PersionBookEntity.ListinfoBean entity = itemList.get(position);
        if (entity == null) {
            return null;
        }
        if (view == null) {
        ...
        tvLetterName.setText(entity.getStaffName());
        tvLetterJob.setText(entity.getDeptName() + " | " + entity.getRoleName());
        return view;
    }
