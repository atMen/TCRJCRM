...
import com.tcrj.spv.presenter.ExpatriateSignOutPresenter;
 ...
 * 外派签退
 */
public class ExpatriateSignOutActivity extends BaseActivity implements View.OnClickListener,
    ...
    private ExpatriateSignOutActivity.MyCancelCallback myCancelCallback = new ExpatriateSignOutActivity.MyCancelCallback();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //构造业务逻辑控制类
        new ExpatriateSignOutPresenter(this);
        ...
        if (aMap == null) {
            ...
            aMap.setOnInfoWindowClickListener(new AMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    ...
                    Intent intent = new Intent(ExpatriateSignOutActivity.this, PositionInfoActivity.class);
