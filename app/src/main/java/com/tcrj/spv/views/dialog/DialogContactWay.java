...
public class DialogContactWay extends Dialog implements DialogInterface {
    private View view;
    private int mDuration = -1;
    private Effectstype type = null;
    private static Context mContext;
    private boolean isCancelable = true;
    private static DialogContactWay instance;
    ...
    public DialogContactWay(Context context, List<PublicListEntity> itemList) {
    ...
    public static DialogContactWay getInstance(Context context, List<PublicListEntity> itemList) {
        if (instance == null || !mContext.equals(context)) {
            synchronized (MessageDialogBuilder.class) {
                if (instance == null || !mContext.equals(context)) {
                    instance = new DialogContactWay(context, itemList);
                }
            }
        }
        mContext = context;
    ...
    public DialogContactWay setDuration(int duration) {
        this.mDuration = duration;
        return this;
    }

    public DialogContactWay setEffect(Effectstype type) {
        this.type = type;
        return this;
    }

    public DialogContactWay setTitleName(int textResId) {
        txtTitle.setText(textResId);
        return this;
    }

    public DialogContactWay setTitleName(CharSequence msg) {
        txtTitle.setText(msg);
        return this;
    }

    public DialogContactWay isCancelableOnTouchOutside(boolean cancelable) {
        this.isCancelable = cancelable;
        this.setCanceledOnTouchOutside(cancelable);
        return this;
    }

    public DialogContactWay isCancelable(boolean cancelable) {
        this.isCancelable = cancelable;
