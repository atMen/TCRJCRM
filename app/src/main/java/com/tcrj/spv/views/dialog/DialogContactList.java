...
public class DialogContactList extends Dialog implements DialogInterface {
    private View view;
    private int mDuration = -1;
    private Effectstype type = null;
    private static Context mContext;
    private boolean isCancelable = true;
    private static DialogContactList instance;
    ...
    public DialogContactList(Context context, List<PublicListEntity> itemList) {
    ...
    public static DialogContactList getInstance(Context context, List<PublicListEntity> itemList) {
        if (instance == null || !mContext.equals(context)) {
            synchronized (MessageDialogBuilder.class) {
                if (instance == null || !mContext.equals(context)) {
                    instance = new DialogContactList(context, itemList);
                }
            }
        }
        mContext = context;
    ...
    public DialogContactList setDuration(int duration) {
        this.mDuration = duration;
        return this;
    }

    public DialogContactList setEffect(Effectstype type) {
        this.type = type;
        return this;
    }

    public DialogContactList setTitleName(int textResId) {
        txtTitle.setText(textResId);
        return this;
    }

    public DialogContactList setTitleName(CharSequence msg) {
        txtTitle.setText(msg);
        return this;
    }

    public DialogContactList isCancelableOnTouchOutside(boolean cancelable) {
        this.isCancelable = cancelable;
        this.setCanceledOnTouchOutside(cancelable);
        return this;
    }

    public DialogContactList isCancelable(boolean cancelable) {
        this.isCancelable = cancelable;
