...
public class CustomerTypeAdapter extends BaseAdapter {
    ...
    private List<CustomerTypeEntity.ListInfoBean> itemList;
    ...
    public void setData(List<CustomerTypeEntity.ListInfoBean> list) {
        this.itemList.clear();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        final CustomerTypeEntity.ListInfoBean entity = (CustomerTypeEntity.ListInfoBean) itemList.get(position);
        if (entity == null) {
            return null;
        }
        if (view == null) {
        ...
        view.setId(position);
        tvNoticeTitle.setText(entity.getCustomerClassName());
        if (select == position) {
