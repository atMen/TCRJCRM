 ...
 */
public class FollowRecordExisAdapter extends BaseAdapter {
    private List<ListInfoBean> itemList;
    private final Context context;
    private final LayoutInflater inflater;
    private int selectItem = -1;

    public FollowRecordExisAdapter(Context context, List<ListInfoBean> itemList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.item_public_listview, null);
...
//            view.setBackgroundColor(Color.parseColor("#ff7800"));
        } else {
            viewHolder.layoutContent.setBackgroundColor(Color.parseColor("#f7f7f7"));
