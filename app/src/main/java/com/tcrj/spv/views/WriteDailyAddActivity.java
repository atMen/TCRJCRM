 ...
 * 写日报
 */
public class WriteDailyAddActivity extends BaseActivity implements View.OnClickListener, WriteDailyCallBack.View {
...
//    UserInfoEntity user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_writedaily);
...
//                  dateTimeString = DateUtils.getDateTimeString(new Date());
            ...
            case R.id.layout_work_naturejob:
                ...
                dialog.setOnItemClickListener(new DialogWorkDaily.IListViewCallBack() {
                    ...
                    public void setOnClickListener(PublicListEntity entity) {
                        ...
                        if (entity.getCode().equals("2")) {
                            commonEntity.setWorkid(entity.getId());
                            layoutWorkProject.setVisibility(View.GONE);
                            new WriteDailyPresenter(WriteDailyAddActivity.this, 0);
            ...
            case R.id.layout_work_project:
                Intent pro = new Intent(WriteDailyAddActivity.this, WriteDailyProjectActivity.class);
    ...
    public ParameterEntity setParameter() {
        ...
        Log.e("TAG","项目性质："+commonEntity.getWorkid());
        ...
        switch (requestCode) {
            case 100:
                if (resultCode == 3) {
                    ...
                    int currentState = b.getInt("CurrentState");
                    commonEntity.setPID(String.valueOf(pid));

                    if(currentState == 12){
                        commonEntity.setWorkid(2);
                    }else if(currentState == 8){
                        commonEntity.setWorkid(3);
                    }else {
                        commonEntity.setWorkid(1);
                    }
