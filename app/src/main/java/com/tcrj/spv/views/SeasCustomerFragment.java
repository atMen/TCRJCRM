...
public class SeasCustomerFragment extends Fragment implements CustomerInfoCallBack.View {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new CustomerInfoPresenter(SeasCustomerFragment.this);
        setCommonality();
        initView(view);
        presenter.start();
        return view;
