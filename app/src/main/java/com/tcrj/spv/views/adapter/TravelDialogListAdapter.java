...
public class TravelDialogListAdapter extends BaseAdapter {
    private List<ccSPInfo.NodesBean> itemList;
    private final Context context;
    private final LayoutInflater inflater;
    private int select = -1;

    public TravelDialogListAdapter(Context context) {
        this.context = context;
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

    }

    public void setData(ccSPInfo list) {
    ...
    public View getView(int id, View view, ViewGroup parent) {
        ...
        ccSPInfo.NodesBean data = itemList.get(id);
        if (data == null){
            return null;
        }
