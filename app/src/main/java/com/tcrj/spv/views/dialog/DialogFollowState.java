...
public class DialogFollowState extends Dialog implements DialogInterface {
    private View view;
    private int mDuration = -1;
    private Effectstype type = null;
    private static Context mContext;
    private boolean isCancelable = true;
    private static DialogFollowState instance;
    ...
    public DialogFollowState(Context context, List<PublicListEntity> itemList) {
    ...
    public static DialogFollowState getInstance(Context context, List<PublicListEntity> itemList) {
        if (instance == null || !mContext.equals(context)) {
            synchronized (MessageDialogBuilder.class) {
                if (instance == null || !mContext.equals(context)) {
                    instance = new DialogFollowState(context, itemList);
                }
            }
        }
        mContext = context;
    ...
    public DialogFollowState setDuration(int duration) {
        this.mDuration = duration;
        return this;
    }

    public DialogFollowState setEffect(Effectstype type) {
        this.type = type;
        return this;
    }

    public DialogFollowState setTitleName(int textResId) {
        txtTitle.setText(textResId);
        return this;
    }

    public DialogFollowState setTitleName(CharSequence msg) {
        txtTitle.setText(msg);
        return this;
    }

    public DialogFollowState isCancelableOnTouchOutside(boolean cancelable) {
        this.isCancelable = cancelable;
        this.setCanceledOnTouchOutside(cancelable);
        return this;
    }

    public DialogFollowState isCancelable(boolean cancelable) {
        this.isCancelable = cancelable;
